...
function dbCallback(){
    ...
    var analyses = require('./pages/qaallanalyses.js')(app, localization.myLocalize, functions, db.con, router, localization.localization);
    ...
    var qaanalysesoperation = require('./pages/qaanalysesoperation.js')(app, localization.myLocalize, functions, db.con, router, localization.localization);
